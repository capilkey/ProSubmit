...
<div id="page-content" class="hbox">
	<div class="flex4">
		<%
			...
			ArrayList<HashMap<String,String>> projectcats = new ArrayList<HashMap<String,String>>(); 
			projectHandler.getAllCategoryInfo(projectcats);
			
			HashMap<String,String> userInfo = (HashMap<String,String>)session.getAttribute("userInfo");
		%>
		<h1>Project Proposal</h1>
		<div id="create-project-error-message" class="alert alert-danger"></div>
